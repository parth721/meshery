...
## Main_command : system
### start 
`mesheryctl system start` : This will initiate the Meshery & automatically open it in your default web browser.

<a href="{{ site.baseurl }}/assets/img/syscmd/start.png"><img alt="start" style="width:500px;height:auto;" src="{{ site.baseurl }}/assets/img/syscmd/start.png" /></a>
...
<a href="{{ site.baseurl }}/assets/img/syscmd/system update.png"><img alt="context-view" style="width:500px;height:auto;" src="{{ site.baseurl }}/assets/img/syscmd/system update.png" /></a>
...
`mesheryctl system stop --force` : Force stops Meshery instead of  gentle way. This is used only in emergency situations when `mesheryctl system stop` can't halt Meshery.
